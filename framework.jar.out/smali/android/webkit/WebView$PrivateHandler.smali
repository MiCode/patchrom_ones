...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-static {v2, v3}, Landroid/webkit/WebView;->access$9402(Landroid/webkit/WebView;Z)Z
    ...
    invoke-static {v2}, Landroid/webkit/WebView;->access$10400(Landroid/webkit/WebView;)V
    ...
    invoke-static {v2}, Landroid/webkit/WebView;->access$10500(Landroid/webkit/WebView;)Landroid/webkit/AccessibilityInjector;
    ...
    invoke-static {v2, v0}, Landroid/webkit/WebView;->access$10600(Landroid/webkit/WebView;Ljava/util/ArrayList;)V
    ...
    invoke-static {v2, v3, v4}, Landroid/webkit/WebView;->access$10700(Landroid/webkit/WebView;II)V
    ...
    #getter for: Landroid/webkit/WebView;->mContext:Landroid/content/Context;
    invoke-static {v3}, Landroid/webkit/WebView;->access$10800(Landroid/webkit/WebView;)Landroid/content/Context;

    move-result-object v3

    #calls: Landroid/webkit/WebView;->setupPackageListener(Landroid/content/Context;)V
    invoke-static {v2, v3}, Landroid/webkit/WebView;->access$10900(Landroid/webkit/WebView;Landroid/content/Context;)V
    ...
    #getter for: Landroid/webkit/WebView;->mContext:Landroid/content/Context;
    invoke-static {v2}, Landroid/webkit/WebView;->access$11000(Landroid/webkit/WebView;)Landroid/content/Context;

    move-result-object v2

    #calls: Landroid/webkit/WebView;->setupProxyListener(Landroid/content/Context;)V
    invoke-static {v2}, Landroid/webkit/WebView;->access$11100(Landroid/content/Context;)V
    ...
    invoke-static {v2, v3}, Landroid/webkit/WebView;->access$11300(Landroid/webkit/WebView;Z)V
