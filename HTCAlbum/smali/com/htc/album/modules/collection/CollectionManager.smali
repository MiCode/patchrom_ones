...
.method private addItemToCollection(Ljava/util/HashMap;Landroid/content/Context;ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;JLjava/lang/String;IJJ)V
    .locals 15
    .parameter
    .parameter "context"
...
.method private addItemToSmartCollection(Ljava/util/HashMap;Landroid/content/Context;ILjava/lang/String;Ljava/lang/String;JLjava/lang/String;IJJ)V
    ...
    invoke-direct/range {v0 .. v15}, Lcom/htc/album/modules/collection/CollectionManager;->addItemToCollection(Ljava/util/HashMap;Landroid/content/Context;ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;JLjava/lang/String;IJJ)V
...
.method private loadCollectionFromSource(Landroid/content/Context;Ljava/util/HashMap;ILjava/lang/String;)V
    ...
    .line 168
    .local v25, bucketId:Ljava/lang/String;
    const/4 v3, 0x2
    ...
    .line 170
    .local v26, folderName:Ljava/lang/String;
    const/4 v3, 0x3
    ...
    invoke-direct/range {v6 .. v19}, Lcom/htc/album/modules/collection/CollectionManager;->addItemToSmartCollection(Ljava/util/HashMap;Landroid/content/Context;ILjava/lang/String;Ljava/lang/String;JLjava/lang/String;IJJ)V
    ...
    .end local v25           #bucketId:Ljava/lang/String;
    .end local v26           #folderName:Ljava/lang/String;
    .end local v46           #isFavorite:Z
    :catch_1
    move-exception v39
    ...
    .restart local v25       #bucketId:Ljava/lang/String;
    .restart local v26       #folderName:Ljava/lang/String;
    :cond_d
    const/16 v46, 0x0
    ...
    .line 222
    .restart local v46       #isFavorite:Z
    :cond_e
    const/16 v3, 0xe0
    ...
    .line 258
    .local v44, inSnapbooth:Z
    const/16 v42, 0x0

    .line 260
    .local v42, inPanorama:Z
    ...
    .line 290
    .end local v42           #inPanorama:Z
    .end local v44           #inSnapbooth:Z
    :cond_15
    :goto_a
    const/16 v47, 0x0
    ...
    invoke-static/range {v48 .. v48}, Lcom/htc/sunny2/frameworks/utils/DeviceStorageManager;->isFileOnAllDownloads(Ljava/lang/String;)Z
    ...
    .line 340
    const-string v24, "com.htc.HTCAlbum.LOCAL_FOLDER"
    ...
    invoke-direct/range {v20 .. v35}, Lcom/htc/album/modules/collection/CollectionManager;->addItemToCollection(Ljava/util/HashMap;Landroid/content/Context;ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;JLjava/lang/String;IJJ)V

    goto/16 :goto_2

    .line 242
    .end local v40           #inAllDownloads:Z
    .end local v41           #inCameraShots:Z
    .end local v43           #inScribbles:Z
    .end local v45           #is3dContent:Z
    .end local v47           #isInked:Z
    ...
    .line 262
    .restart local v41       #inCameraShots:Z
    .restart local v42       #inPanorama:Z
    .restart local v44       #inSnapbooth:Z
    :cond_1e
    const/16 v44, 0x0
    ...
    .end local v42           #inPanorama:Z
    .end local v44           #inSnapbooth:Z
    .restart local v43       #inScribbles:Z
    .restart local v47       #isInked:Z
    :cond_22
    const/16 v47, 0x0
    ...
    .line 317
    .restart local v45       #is3dContent:Z
    :cond_24
    const/16 v45, 0x0
