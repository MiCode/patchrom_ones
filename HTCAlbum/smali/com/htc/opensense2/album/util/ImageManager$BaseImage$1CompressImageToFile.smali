...
.method public get()Z
    ...
    .line 322
    .local v2, t1:J
    iget-object v11, p0, Lcom/htc/opensense2/album/util/ImageManager$BaseImage$1CompressImageToFile;->this$1:Lcom/htc/opensense2/album/util/ImageManager$BaseImage;

    iget-object v11, v11, Lcom/htc/opensense2/album/util/ImageManager$BaseImage;->mContentResolver:Landroid/content/ContentResolver;

    iget-object v12, p0, Lcom/htc/opensense2/album/util/ImageManager$BaseImage$1CompressImageToFile;->val$uri:Landroid/net/Uri;
    ...
    .line 324
    :try_start_1
    invoke-virtual {p0}, Lcom/htc/opensense2/album/util/ImageManager$BaseImage$1CompressImageToFile;->checkCanceled()V

    .line 325
    new-instance v11, Lcom/htc/opensense2/album/util/ImageManager$ThreadSafeOutputStream;

    iget-object v12, p0, Lcom/htc/opensense2/album/util/ImageManager$BaseImage$1CompressImageToFile;->this$1:Lcom/htc/opensense2/album/util/ImageManager$BaseImage;

    iget-object v12, v12, Lcom/htc/opensense2/album/util/ImageManager$BaseImage;->this$0:Lcom/htc/opensense2/album/util/ImageManager;

    invoke-direct {v11, v12, v0}, Lcom/htc/opensense2/album/util/ImageManager$ThreadSafeOutputStream;-><init>(Lcom/htc/opensense2/album/util/ImageManager;Ljava/io/OutputStream;)V

    iput-object v11, p0, Lcom/htc/opensense2/album/util/ImageManager$BaseImage$1CompressImageToFile;->mOutputStream:Lcom/htc/opensense2/album/util/ImageManager$ThreadSafeOutputStream;
    ...
    .line 328
    .local v4, t2:J
    iget-object v11, p0, Lcom/htc/opensense2/album/util/ImageManager$BaseImage$1CompressImageToFile;->val$bitmap:Landroid/graphics/Bitmap;
    ...
    invoke-virtual {v12}, Lcom/htc/opensense2/album/util/ImageManager$BaseImage;->compressionType()Landroid/graphics/Bitmap$CompressFormat;

    move-result-object v12

    const/16 v13, 0x4b

    iget-object v14, p0, Lcom/htc/opensense2/album/util/ImageManager$BaseImage$1CompressImageToFile;->mOutputStream:Lcom/htc/opensense2/album/util/ImageManager$ThreadSafeOutputStream;
    ...
    .line 350
    iget-object v11, p0, Lcom/htc/opensense2/album/util/ImageManager$BaseImage$1CompressImageToFile;->mOutputStream:Lcom/htc/opensense2/album/util/ImageManager$ThreadSafeOutputStream;
    ...
    invoke-virtual {v11}, Lcom/htc/opensense2/album/util/ImageManager$ThreadSafeOutputStream;->close()V
    :try_end_3
    ...
    :cond_0
    :goto_1
    invoke-virtual {p0}, Lcom/htc/opensense2/album/util/ImageManager$BaseImage$1CompressImageToFile;->acknowledgeCancel()V
    ...
    iget-object v12, p0, Lcom/htc/opensense2/album/util/ImageManager$BaseImage$1CompressImageToFile;->val$jpegData:[B

    invoke-virtual {v11, v12}, Lcom/htc/opensense2/album/util/ImageManager$ThreadSafeOutputStream;->write([B)V
    ...
    .line 343
    .local v1, ex:Lcom/htc/opensense2/album/util/ImageManager$CanceledException;
    :try_start_9
    invoke-virtual {v1}, Lcom/htc/opensense2/album/util/ImageManager$CanceledException;->printStackTrace()V
    :try_end_9
    ...
    .line 358
    .end local v1           #ex:Lcom/htc/opensense2/album/util/ImageManager$CanceledException;
    :cond_3
    :goto_4
    invoke-virtual {p0}, Lcom/htc/opensense2/album/util/ImageManager$BaseImage$1CompressImageToFile;->acknowledgeCancel()V
