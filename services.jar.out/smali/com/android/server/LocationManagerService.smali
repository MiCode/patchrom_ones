...
.method static synthetic access$1300(Lcom/android/server/LocationManagerService;)Ljava/lang/String;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$1302(Lcom/android/server/LocationManagerService;Ljava/lang/String;)Ljava/lang/String;
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$1400(Lcom/android/server/LocationManagerService;)Lcom/android/server/location/GeocoderProxy;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$1402(Lcom/android/server/LocationManagerService;Lcom/android/server/location/GeocoderProxy;)Lcom/android/server/location/GeocoderProxy;
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$1600(Lcom/android/server/LocationManagerService;Lcom/android/server/location/LocationProviderInterface;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$2700(Lcom/android/server/LocationManagerService;)Ljava/util/HashSet;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$2800(Lcom/android/server/LocationManagerService;Landroid/app/PendingIntent;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$2900(Lcom/android/server/LocationManagerService;)Ljava/util/ArrayList;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$3000(Lcom/android/server/LocationManagerService;Ljava/lang/String;)Z
    .locals 1
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$3200(Lcom/android/server/LocationManagerService;Landroid/location/Location;Z)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    .parameter "x2"
...
.method private handleLocationChangedLocked(Landroid/location/Location;Z)V
    ...
    .line 2320
    .local v21, records:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/server/LocationManagerService$UpdateRecord;>;"
    const/16 v23, 0x0

    .local v23, ulpLocationSource:Z
    const/4 v7, 0x0

    .line 2321
    .local v7, gnssLocationSource:Z
    if-eqz v21, :cond_0
    ...
    .line 2318
    .end local v7           #gnssLocationSource:Z
    .end local v17           #provider:Ljava/lang/String;
    .end local v21           #records:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/server/LocationManagerService$UpdateRecord;>;"
    .end local v23           #ulpLocationSource:Z
    :cond_1
    ...
    .line 2325
    .restart local v7       #gnssLocationSource:Z
    .restart local v17       #provider:Ljava/lang/String;
    .restart local v21       #records:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/server/LocationManagerService$UpdateRecord;>;"
    .restart local v23       #ulpLocationSource:Z
    :cond_2
    move-object/from16 v0, p0
    ...
    invoke-interface {v14}, Lcom/android/server/location/LocationProviderInterface;->getCapability()I

    move-result v24

    and-int/lit8 v24, v24, 0x20
    ...
    .line 2340
    .local v11, locationExtraInfo:Landroid/os/Bundle;
    :try_start_0
    const-string v24, "ProviderSourceIsUlp"
    ...
    .line 2341
    const-string v24, "ProviderSourceIsGnss"
    ...
    .line 2353
    .end local v11           #locationExtraInfo:Landroid/os/Bundle;
    :cond_3
    :goto_1
    const/16 v24, 0x1
    ...
    :cond_4
    :goto_2
    invoke-interface {v14}, Lcom/android/server/location/LocationProviderInterface;->getStatusUpdateTime()J
    ...
    invoke-interface {v14, v6}, Lcom/android/server/location/LocationProviderInterface;->getStatus(Landroid/os/Bundle;)I
    ...
    .line 2379
    .local v18, r:Lcom/android/server/LocationManagerService$UpdateRecord;
    move-object/from16 v0, v18
    ...
    .line 2380
    .local v19, receiver:Lcom/android/server/LocationManagerService$Receiver;
    const/16 v20, 0x0

    .line 2388
    .local v20, receiverDead:Z
    const/16 v24, 0x1
    ...
    .end local v18           #r:Lcom/android/server/LocationManagerService$UpdateRecord;
    .end local v19           #receiver:Lcom/android/server/LocationManagerService$Receiver;
    .end local v20           #receiverDead:Z
    ...
    .restart local v18       #r:Lcom/android/server/LocationManagerService$UpdateRecord;
    .restart local v19       #receiver:Lcom/android/server/LocationManagerService$Receiver;
    .restart local v20       #receiverDead:Z
    ...
    invoke-static {v0, v9, v1}, Lcom/android/server/LocationManagerService;->shouldBroadcastSafe(Landroid/location/Location;Landroid/location/Location;Lcom/android/server/LocationManagerService$UpdateRecord;)Z
    ...
    .line 2410
    :goto_5
    sget-boolean v24, Lcom/android/server/LocationManagerService;->CUSTOMIZED_NLP_FEATURE:Z
    ...
    const-string v26, "[CustProvider][onLocationChanged] NLP="
    ...
    const-string v26, "RemoteException calling onLocationChanged on "
    ...
    iget-wide v15, v0, Lcom/android/server/LocationManagerService$UpdateRecord;->mLastStatusBroadcast:J

    .line 2422
    .local v15, prevStatusUpdateTime:J
    cmp-long v24, v12, v15
    ...
    const-string v26, "RemoteException calling onStatusChanged on "
    ...
    .line 2407
    .end local v15           #prevStatusUpdateTime:J
    :cond_10
    move-object/from16 v0, p1
    ...
    .end local v12           #newStatusUpdateTime:J
    .end local v22           #status:I
    .restart local v11       #locationExtraInfo:Landroid/os/Bundle;
    :catch_0
    move-exception v24
...
.method private initialize()V
    ...
    invoke-direct {v12, p0, v1}, Lcom/android/server/LocationManagerService$SettingsObserver;-><init>(Lcom/android/server/LocationManagerService;Lcom/android/server/LocationManagerService$1;)V
    ...
    const-string v13, "customized_location_provider"
    ...
    invoke-direct {v1, v7, v2, v3, v4}, Landroid/content/ContentQueryMap;-><init>(Landroid/database/Cursor;Ljava/lang/String;ZLandroid/os/Handler;)V
    ...
    invoke-direct {v6, p0, v1}, Lcom/android/server/LocationManagerService$CustProviderObserver;-><init>(Lcom/android/server/LocationManagerService;Lcom/android/server/LocationManagerService$1;)V
...
.method private removeUpdatesLocked(Lcom/android/server/LocationManagerService$Receiver;)V
    ...
    .line 1673
    .local v15, package_name:Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    invoke-virtual {v0, v9}, Landroid/content/pm/PackageManager;->getNameForUid(I)Ljava/lang/String;
    ...
    const-string v5, "[LPS] (XXXXX) removeUpdatesLocked: com.htc.laputa , Receiver = "
    ...
    .line 1696
    .local v18, providers:Ljava/util/HashSet;,"Ljava/util/HashSet<Ljava/lang/String;>;"
    move-object/from16 v0, p1

    iget-object v14, v0, Lcom/android/server/LocationManagerService$Receiver;->mUpdateRecords:Ljava/util/HashMap;

    .line 1697
    .local v14, oldRecords:Ljava/util/HashMap;,"Ljava/util/HashMap<Ljava/lang/String;Lcom/android/server/LocationManagerService$UpdateRecord;>;"
    if-eqz v14, :cond_7
    ...
    invoke-virtual {v3, v0}, Lcom/android/server/LocationManagerService$Receiver;->equals(Ljava/lang/Object;)Z
    ...
    .end local v14           #oldRecords:Ljava/util/HashMap;,"Ljava/util/HashMap<Ljava/lang/String;Lcom/android/server/LocationManagerService$UpdateRecord;>;"
    .end local v18           #providers:Ljava/util/HashSet;,"Ljava/util/HashSet<Ljava/lang/String;>;"
    ...
    .restart local v14       #oldRecords:Ljava/util/HashMap;,"Ljava/util/HashMap<Ljava/lang/String;Lcom/android/server/LocationManagerService$UpdateRecord;>;"
    .restart local v18       #providers:Ljava/util/HashSet;,"Ljava/util/HashSet<Ljava/lang/String;>;"
    :cond_6
    ...
    const-string v4, "[LPS] removeUpdatesLocked: Call by back-door AP: com.htc.laputa"
    ...
    .line 1752
    .local v20, recordsForProvider:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/server/LocationManagerService$UpdateRecord;>;"
    if-eqz v20, :cond_a
    ...
    const-string v4, "[LPS] In removeUpdatesLocked.p.setMinTime:"
    ...
    sget v3, Lcom/android/server/LocationManagerService;->mPrivacyLock:I
    ...
    const-string v4, "[LPS] (XXX) removeUpdatesLocked: enableLocationTracking(false) calling by back-door AP. "
    ...
    const-string v4, "removeUpdatesLocked: enableLocationTracking(false)"
    ...
    .end local v17           #provider:Ljava/lang/String;
    .end local v20           #recordsForProvider:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/server/LocationManagerService$UpdateRecord;>;"
    :cond_c
    invoke-static {v12, v13}, Landroid/os/Binder;->restoreCallingIdentity(J)V
...
.method private updateProvidersLocked()V
    ...
    const-string v11, "##### updateProvidersLocked #####: enable_lock: 0 (Enable)"
...
.method public getBestProvider(Landroid/location/Criteria;Z)Ljava/lang/String;
    ...
    .line 1105
    invoke-interface {v3}, Lcom/android/server/location/LocationProviderInterface;->getCapability()I
    ...
    .line 1124
    invoke-direct {p0, v4}, Lcom/android/server/LocationManagerService;->nextPower(I)I
    ...
    .restart local v1       #criteria:Landroid/location/Criteria;
    :cond_5
    invoke-virtual {v1, v7}, Landroid/location/Criteria;->setBearingRequired(Z)V
    ...
    .restart local v1       #criteria:Landroid/location/Criteria;
    :cond_6
    invoke-virtual {v1, v7}, Landroid/location/Criteria;->setSpeedRequired(Z)V
    ...
    .restart local v1       #criteria:Landroid/location/Criteria;
    :cond_7
    invoke-virtual {v1, v7}, Landroid/location/Criteria;->setAltitudeRequired(Z)V
