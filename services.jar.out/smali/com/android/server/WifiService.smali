...
.field private static final ICON_NETWORKS_AVAILABLE:I = 0x402001a
...
.method constructor <init>(Landroid/content/Context;)V
    ...
    .line 210
    iput-boolean v10, p0, Lcom/android/server/WifiService;->mWifiOffloadEnabled:Z
...
.method static synthetic access$5000(Lcom/android/server/WifiService;Z)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$5102(Lcom/android/server/WifiService;I)I
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$5200(Lcom/android/server/WifiService;II)Z
    .locals 1
    .parameter "x0"
    .parameter "x1"
    .parameter "x2"
...
.method static synthetic access$5300(Lcom/android/server/WifiService;)Landroid/app/PendingIntent;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$5400(Lcom/android/server/WifiService;)Landroid/app/AlarmManager;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$6200(Lcom/android/server/WifiService;)Lcom/android/server/WifiService$LockList;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$6300(Lcom/android/server/WifiService;Landroid/os/IBinder;)Z
    .locals 1
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$7100(Lcom/android/server/WifiService;)Ljava/util/List;
    .locals 1
    .parameter "x0"
...
.method private acquireWifiLockLocked(Lcom/android/server/WifiService$WifiLock;)Z
    ...
    invoke-static {v3, p1}, Lcom/android/server/WifiService$LockList;->access$6800(Lcom/android/server/WifiService$LockList;Lcom/android/server/WifiService$WifiLock;)V
...
.method private checkAndSetNotification()V
    ...
    .line 3458
    iget-boolean v6, p0, Lcom/android/server/WifiService;->mVzwWifiStatusFeature:Z
    ...
    iget-boolean v6, p0, Lcom/android/server/WifiService;->mSecureNetworkNotificationEnabled:Z
    ...
    const-string v7, "Enter numScansSinceNetworkStateChange"
    ...
    invoke-direct {p0, v9, v6, v8, v8}, Lcom/android/server/WifiService;->setNotificationVisible(ZIZI)V
    ...
    .line 3528
    invoke-direct {p0, v9, v1, v8, v8}, Lcom/android/server/WifiService;->setNotificationVisible(ZIZI)V
    ...
    .line 3542
    invoke-direct {p0, v9, v2, v8, v8}, Lcom/android/server/WifiService;->setNotificationVisible(ZIZI)V
    ...
    .end local v2           #numSecureNetworks:I
    .end local v4           #scanResults:Ljava/util/List;,"Ljava/util/List<Landroid/net/wifi/ScanResult;>;"
    :cond_9
    invoke-direct {p0, v8, v8, v8, v8}, Lcom/android/server/WifiService;->setNotificationVisible(ZIZI)V
...
.method private releaseWifiLockLocked(Landroid/os/IBinder;)Z
    ...
    invoke-static {v4, p1}, Lcom/android/server/WifiService$LockList;->access$7000(Lcom/android/server/WifiService$LockList;Landroid/os/IBinder;)Lcom/android/server/WifiService$WifiLock;
...
.method private declared-synchronized reportStartWorkSource()V
    ...
    invoke-static {v1}, Lcom/android/server/WifiService$LockList;->access$5800(Lcom/android/server/WifiService$LockList;)Ljava/util/List;
...
.method private updateWifiState()V
    ...
    invoke-static {v8}, Lcom/android/server/WifiService$LockList;->access$5900(Lcom/android/server/WifiService$LockList;)Z
    ...
    invoke-static {v8}, Lcom/android/server/WifiService$LockList;->access$6000(Lcom/android/server/WifiService$LockList;)I
...
.method public checkAndStartWifi()V
    ...
    :cond_0
    iput-boolean v5, p0, Lcom/android/server/WifiService;->mWifiOffloadEnabled:Z
    :try_end_0
    .catch Landroid/provider/Settings$SettingNotFoundException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 1302
    .local v1, e:Landroid/provider/Settings$SettingNotFoundException;
    const-string v5, "wifi_offload_enabled"
    ...
    const-string v5, "WifiOffload: init WIFI_OFFLOAD_ENABLED to 1 in getpersistWifiOffloadEnabled"
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    invoke-static {v3, p2}, Lcom/android/server/WifiService$LockList;->access$6100(Lcom/android/server/WifiService$LockList;Ljava/io/PrintWriter;)V
...
.method public updateWifiLockWorkSource(Landroid/os/IBinder;Landroid/os/WorkSource;)V
    ...
    invoke-static {v6, p1}, Lcom/android/server/WifiService$LockList;->access$6900(Lcom/android/server/WifiService$LockList;Landroid/os/IBinder;)I
    ...
    #getter for: Lcom/android/server/WifiService$LockList;->mList:Ljava/util/List;
    invoke-static {v6}, Lcom/android/server/WifiService$LockList;->access$5800(Lcom/android/server/WifiService$LockList;)Ljava/util/List;
