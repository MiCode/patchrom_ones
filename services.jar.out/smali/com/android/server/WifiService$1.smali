...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    invoke-static {v5}, Lcom/android/server/WifiService;->access$1600(Lcom/android/server/WifiService;)Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-static {v5}, Lcom/android/server/WifiService;->access$1700(Lcom/android/server/WifiService;)Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-static {v5, v3}, Lcom/android/server/WifiService;->access$1800(Lcom/android/server/WifiService;Z)V
    ...
    invoke-static {v5}, Lcom/android/server/WifiService;->access$1000(Lcom/android/server/WifiService;)Z
    ...
    invoke-static {v5}, Lcom/android/server/WifiService;->access$1900(Lcom/android/server/WifiService;)Z

    move-result v1

    .line 661
    .local v1, wifiApEnabled:Z
    iget-object v5, p0, Lcom/android/server/WifiService$1;->this$0:Lcom/android/server/WifiService;
    ...
    .line 663
    .local v2, wifiApShouldBeEnabled:Z
    :goto_1
    if-eqz v2, :cond_5
    ...
    invoke-static {v4, v3, v7, v5}, Lcom/android/server/WifiService;->access$2000(Lcom/android/server/WifiService;ZLandroid/net/wifi/WifiConfiguration;I)V

    .line 679
    .end local v0           #wifiApAirplaneMode:Z
    .end local v1           #wifiApEnabled:Z
    .end local v2           #wifiApShouldBeEnabled:Z
    :cond_1
    :goto_2
    ...
    .restart local v1       #wifiApEnabled:Z
    :cond_3
    move v0, v4
    ...
    .restart local v0       #wifiApAirplaneMode:Z
    :cond_4
    move v2, v4
    ...
    .line 667
    .restart local v2       #wifiApShouldBeEnabled:Z
    :cond_5
    ...
    invoke-static {v3, v4}, Lcom/android/server/WifiService;->access$1002(Lcom/android/server/WifiService;Z)Z
