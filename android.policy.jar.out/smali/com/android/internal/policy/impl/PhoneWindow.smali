...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 202
    iput v4, p0, Lcom/android/internal/policy/impl/PhoneWindow;->mVolumeControlStreamType:I

    .line 207
    iput v2, p0, Lcom/android/internal/policy/impl/PhoneWindow;->mUiOptions:I

    .line 1568
    iput-boolean v3, p0, Lcom/android/internal/policy/impl/PhoneWindow;->isPortrait:Z
...
.method private showNavigationBarTips(Z)V
    ...
    const-string v11, "showNavigationBarTips, don\'t show top, pkg: "
    ...
    const-string v11, " in black list"
    ...
    const-string v11, "showNavigationBarTips, show dialog, title: "
...
.method protected generateLayout(Lcom/android/internal/policy/impl/PhoneWindow$DecorView;)Landroid/view/ViewGroup;
    ...
    invoke-virtual {v0, v1, v12}, Lcom/android/internal/policy/impl/PhoneWindow;->setFlags(II)V
    ...
    .line 2644
    .local v28, targetPreHoneycomb:Z
    :goto_3
    const/16 v31, 0xe
    ...
    .line 2647
    .local v27, targetHcNeedsOptions:Z
    const/16 v31, 0x8
    ...
    .line 2666
    .local v22, params:Landroid/view/WindowManager$LayoutParams;
    ...
    .line 2715
    .local v11, features:I
    and-int/lit8 v31, v11, 0x18
    ...
    .line 2718
    .local v24, res:Landroid/util/TypedValue;
    invoke-virtual/range {p0 .. p0}, Lcom/android/internal/policy/impl/PhoneWindow;->getContext()Landroid/content/Context;
    ...
    .line 2725
    .end local v24           #res:Landroid/util/TypedValue;
    ...
    invoke-virtual/range {v31 .. v31}, Lcom/android/internal/policy/impl/PhoneWindow$DecorView;->startChanging()V

    .line 2774
    const/16 v16, 0x0

    .line 2777
    .local v16, in:Landroid/view/View;
    move-object/from16 v0, p0
    ...
    invoke-direct/range {v31 .. v33}, Landroid/view/ViewGroup$LayoutParams;-><init>(II)V
    ...
    const-string v33, "layoutResource: "
    ...
    const-string v32, "LayoutInflater.inflate() = null"

    invoke-static/range {v31 .. v32}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 2828
    .end local v16           #in:Landroid/view/View;
    :goto_a
    new-instance v31, Ljava/lang/RuntimeException;

    const-string v32, "Window couldn\'t find content container view"
    ...
    .end local v11           #features:I
    .end local v17           #layoutResource:I
    .end local v20           #noActionBar:Z
    .end local v22           #params:Landroid/view/WindowManager$LayoutParams;
    .end local v27           #targetHcNeedsOptions:Z
    .end local v28           #targetPreHoneycomb:Z
    .end local v29           #targetPreIcs:Z
    .end local v30           #targetSdk:I
    :cond_12
    const v31, 0x10100
    ...
    .line 2644
    .restart local v28       #targetPreHoneycomb:Z
    :cond_16
    const/16 v29, 0x0
    ...
    .line 2647
    .restart local v27       #targetHcNeedsOptions:Z
    .restart local v29       #targetPreIcs:Z
    :cond_17
    const/16 v20, 0x0
    ...
    .line 2652
    .restart local v20       #noActionBar:Z
    :cond_18
    const/high16 v31, 0x800
    ...
    .line 2722
    .restart local v11       #features:I
    .restart local v22       #params:Landroid/view/WindowManager$LayoutParams;
    :cond_19
    const v17, 0x1090089
    ...
    .line 2738
    .restart local v24       #res:Landroid/util/TypedValue;
    invoke-virtual/range {p0 .. p0}, Lcom/android/internal/policy/impl/PhoneWindow;->getContext()Landroid/content/Context;
    ...
    .line 2784
    .restart local v16       #in:Landroid/view/View;
    :cond_23
    sget-object v31, Lcom/htc/R$styleable;->HtcFakescreen:[I
    ...
    iput-boolean v0, v1, Lcom/android/internal/policy/impl/PhoneWindow;->isPortrait:Z
    ...
    const-string v33, "generateLayout(): fakeHeader:"
    ...
    const-string v33, " fakeBackground:"
    ...
    const-string v33, "LayoutInflater.inflate() = "
    ...
    .line 2833
    .local v23, progress:Landroid/widget/ProgressBar;
    if-eqz v23, :cond_2b
    ...
    .line 2840
    .end local v23           #progress:Landroid/widget/ProgressBar;
    :cond_2b
    invoke-virtual/range {p0 .. p0}, Lcom/android/internal/policy/impl/PhoneWindow;->getContainer()Landroid/view/Window;
    ...
    iget-object v10, v0, Lcom/android/internal/policy/impl/PhoneWindow;->mBackgroundDrawable:Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0, v10}, Lcom/android/internal/policy/impl/PhoneWindow$DecorView;->setWindowBackground(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v0, v10}, Lcom/android/internal/policy/impl/PhoneWindow$DecorView;->setWindowFrame(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 2871
    .local v25, resource:Landroid/content/res/Resources;
    const/4 v15, 0x0

    .line 2873
    .local v15, frameBaseView:Landroid/widget/FrameLayout;
    const/16 v19, -0x1

    .line 2876
    .local v19, matchParent:I
    new-instance v15, Landroid/widget/FrameLayout;

    .end local v15           #frameBaseView:Landroid/widget/FrameLayout;
    invoke-direct {v15, v9}, Landroid/widget/FrameLayout;-><init>(Landroid/content/Context;)V

    .line 2877
    .restart local v15       #frameBaseView:Landroid/widget/FrameLayout;
    const/16 v31, 0x1

    move/from16 v0, v31

    invoke-virtual {v15, v0}, Landroid/widget/FrameLayout;->setFitsSystemWindows(Z)V
    ...
    invoke-virtual {v0, v15}, Lcom/android/internal/policy/impl/PhoneWindow$DecorView;->addView(Landroid/view/View;)V
    ...
    .line 2887
    const-string v31, "common_app_bkg"

    const-string v32, "drawable"

    const-string v33, "com.htc"
    ...
    .line 2911
    const-string v31, "common_app_bkg_top_src"
    ...
    .line 2917
    .local v18, lparams:Landroid/widget/FrameLayout$LayoutParams;
    const/16 v31, 0x30
    ...
    iput v14, v0, Landroid/widget/FrameLayout$LayoutParams;->rightMargin:I
    ...
    .end local v18           #lparams:Landroid/widget/FrameLayout$LayoutParams;
    .end local v26           #resourceID:I
    :cond_32
    move-object/from16 v0, p0
    ...
    .line 2952
    .restart local v18       #lparams:Landroid/widget/FrameLayout$LayoutParams;
    move-object/from16 v0, p0
    ...
    const-string v31, "common_app_bkg_down_src"
    ...
    .line 2961
    .local v13, footerBarView:Landroid/view/View;
    move-object/from16 v0, v18
    ...
    .line 2973
    .end local v13           #footerBarView:Landroid/view/View;
    .end local v15           #frameBaseView:Landroid/widget/FrameLayout;
    .end local v18           #lparams:Landroid/widget/FrameLayout$LayoutParams;
    .end local v19           #matchParent:I
    .end local v25           #resource:Landroid/content/res/Resources;
    .end local v26           #resourceID:I
    :cond_34
    move-object/from16 v0, p0
    ...
    invoke-virtual/range {v31 .. v31}, Lcom/android/internal/policy/impl/PhoneWindow$DecorView;->finishChanging()V
    ...
    .line 2892
    .restart local v15       #frameBaseView:Landroid/widget/FrameLayout;
    .restart local v19       #matchParent:I
    .restart local v25       #resource:Landroid/content/res/Resources;
    .restart local v26       #resourceID:I
    :cond_35
    const-string v31, "PhoneWindow"

    const-string v32, "common_app_bkg resource not found!"
    ...
    .restart local v14       #footerOffset:I
    .restart local v18       #lparams:Landroid/widget/FrameLayout$LayoutParams;
    .restart local v26       #resourceID:I
    :cond_37
    const-string v31, "PhoneWindow"

    const-string v32, "common_app_bkg_top_src resource not found!"
    ...
    .line 2956
    :cond_3b
    const-string v31, "common_app_bkg_down_land_src"

    goto :goto_12

    .line 2966
    .restart local v13       #footerBarView:Landroid/view/View;
    .restart local v26       #resourceID:I
    :cond_3c
    const-string v31, "PhoneWindow"

    const-string v32, "common_app_bkg_down resource not found!"
...
.method public setSimpleDecorView(Z)V
    .locals 0
    .parameter "enable"
